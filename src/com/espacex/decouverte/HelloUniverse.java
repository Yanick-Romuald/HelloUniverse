    ...
    public static void main(String... args) {
        ...
        while (recommencer) {
            ...
            if (planeteSelectionnee.restePlaceDisponible(vaisseauSelectionne)) {
                ...
                try {
                        vaisseauSelectionne.emporterCargaison(tonnage);                
                    ...
                    System.out.println("Le vaisseau a rejeté "+ex.tonnageEnExces+" tonnes!");
                    System.out.println("Voulez-vous emporter un tonnage partiel à hauteur de "+(tonnage-ex.tonnageEnExces)+" tonnes ? (Oui/Non)");
                    String reponse=sc.nextLine();
                    
                    
                    if(reponse.equalsIgnoreCase("Oui")){
                        try {
                            vaisseauSelectionne.emporterCargaison(tonnage-ex.tonnageEnExces);
                        } catch (DepassementTonnageException ex1) {
